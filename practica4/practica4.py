...
if __name__ == '__main__':
    ...
    #misterious images
    save_file('imagen1.png', decode_file('mystery_img1.txt'))
    save_file('imagen2.png', decode_file('mystery_img2.txt'))
    ...
    with open('mystery_img1.txt',"rb") as f:
      bytes = f.read() # read entire file as bytes
      readable_hash = hashlib.sha256(bytes).hexdigest();
      print(readable_hash)
      if readable_hash==mystery1:
        print("imagen1 desencriptada")
